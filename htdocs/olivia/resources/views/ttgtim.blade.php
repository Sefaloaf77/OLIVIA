...
@section('container')
    ...
    <!-- meetourteem -->
        ...
        <div class="row meet1">
            ...
            <h1 class="mt-3">Kenalan Dengan Tim SAGA</h1>
            <p>Selangkah lebih dekat dengan kami kuy!</p>
            </div>
    ...
    <!-- quotes -->
        <div class="quotes">
        <h2 class="text-center">“Datang bersama adalah awal,<br>tetap bersama adalah kemajuan, <br>dan bekerja bersama adalah kesuksesan ”
            <br>-Henry Ford-</h2>
        </div>
    <!-- akhir quotes -->
    ...
    <div class="container bio">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-11 card text-center shadow ms-lg-2 ms-md-1 ms-sm-1" data-aos="zoom-in-up">
            <img src="/img/tim/card-angger.png" class="img-fluid" alt="angger">
            <h5>Angger Mahardiani P.</h5>
            <p>Project Manager</p>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 col-11 card text-center shadow ms-lg-2 ms-md-1 ms-sm-1" data-aos="zoom-in-up">
            <img src="/img/tim/card-sefalo.png" class="img-fluid" alt="sefalo">
            <h5>Sefalo 'Aadila Faruq</h5>
            <p>Front End (Ketua)</p>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 col-11 card text-center shadow ms-lg-2 ms-md-1 ms-sm-1" data-aos="zoom-in-up">
            <img src="/img/tim/card-lala.png" class="img-fluid" alt="angger">
            <h5>Allif Nurfaizzatul Uula</h5>
            <p>UI/UX Designer</p>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 col-11 card text-center shadow ms-lg-2 ms-md-1 ms-sm-1" data-aos="zoom-in-up">
            <img src="/img/tim/card-nju.png" class="img-fluid" alt="nju">
            <h5>Nurul Choiriyah</h5>
            <p>Copywriting</p>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 col-11 card text-center shadow ms-lg-2 ms-md-1 ms-sm-1" data-aos="zoom-in-up">
            <img src="/img/tim/card-ricky.png" class="img-fluid" alt="ricky">
            <h5>Ananda Ricky Fauzi</h5>
            <p>Back End & Database Engineering</p>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 col-11 card text-center shadow ms-lg-2 ms-md-1 ms-sm-1" data-aos="zoom-in-up">
            <img src="/img/tim/card-iell.png" class="img-fluid" alt="iel">
            ...
            <div class="row">
                ...
                <div class="accordion" id="accordionPanelsStayOpenExample">
                    ...
                    <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
                        <div class="accordion-body" style="color: #00b3bc;font-size: 20px;">
                        Dengan munculnya berbagai permasalahan sebagai dampak dari pandemi, kami terdorong untuk membuat suatu platform yang dapat membantu mengatasi permasalahan tersebut.
                        </div>
                    </div>
                    </div>
                </div>
