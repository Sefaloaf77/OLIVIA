        ...
        <div class="accordion" id="accordionPanelsStayOpenExample">
          ...
          <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
              <div class="accordion-body">
                Kita semua bisa menjadi bagian dari SAGA, baik sebagai  SOBAT SAGA (penyetor), KURIR, ataupun KOLEGA. Namun tentunya harus memenuhi syarat dan ketentuan yang berlaku. Untuk mengetahui tiga bagian SAGA beserta dengan syarat dan ketentuannya, <a href="/"> silahkan kunjungi tautan berikut </a>
              </div>
            </div>
          </div>
          <div class="accordion-item">
...
<div class="row">
  ...
  <div class="col-md-4 col-10 col-sm-6 col-lg-3 email shadow">
    ...
    <p>Pesan Email</p>
    <a class="btn text-white" href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=CllgCKCDlgwwbBTgRlTJdXVlpWhShkRCxPrvqsjpKwgxPdVhwkpSmkwSMwZjGDvDKQbZPmzFLdB" target="_blank" tabindex="-1" aria-disabled="true">Hubungi Kami</a>
  </div>
  <div class="col-md-4 col-10 col-sm-6 col-lg-3 email shadow">
    <i class="fab fa-instagram icon"></i>
    <p>Pesan Instagram</p>
    <a class="btn text-white" href="https://www.instagram.com/sagavokasiub/" target="_blank" tabindex="-1" aria-disabled="true">Hubungi Kami</a>
  </div>
</div>
  </div>
</div>
