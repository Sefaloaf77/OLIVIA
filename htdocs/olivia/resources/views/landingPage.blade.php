...
@section('container')
    <!-- jumbotrom -->
    <div class="jumbotron" style="background-image: url(/img/beranda/bg-home.png);background-position:right;background-repeat:no-repeat;background-size:contain;">
      <div class="container py-4">
          ...
          <div class="col-md-6 konten">
            <div class="text-dark rounded-3">
              ...
              <div class="d-flex flex-row bd-highlight mb-3">
                <a href="/layanan/setor" class="btn text-white">Yuk Mulai</a>
                <div class="ms-3">
                  <form action="/cari">
        ...
        <div class="col-md-6 gambar">
          <img src="/img/beranda/header.svg" class="img-fluid mt-4" alt="">
        </div>
        </div>
      </div>
    </div>
    ...
    @if (session()->has('kirim'))
      <!-- Modal -->
        <div class="modal hide fade" id="myModalKirim">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-body text-center">
                <img src="/img/beranda/checked.png" alt="checked">
                <h3 style="margin-top: 30px;">Form kamu udah kekirim!</h3>
                <p class="text-center">terima kasih atas pesan kamu ya!</p>
    ...
    <div id="kenalin">
      ...
      <a class="btn text-light" href="/tentang/saga">Tentang SAGA</a>
    </div>
    <!-- akhir tentang saga -->
        ...
        <div class="row justify-content-evenly" data-aos="zoom-in-up">
          ...
          <div class="col-md-4 col-lg-3 mb-3">
            <div class="card shadow">
              ...
              <div class="card-body">
                <h2>Kurir</h2>
                <p class="card-text">Kurir atau Partner SAGA adalah bagian dari SAGA yang berperan sebagai penghubung antara <span style="color: #00b43c;">Sobat SAGA</span> dengan <span style="color: #00b43c;">Kolega.</span></p>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-lg-3 mb-3">
      ...
      <div class="container mt-5">
        <div class="row">
          ...
          <div class="col-sm keterangan">
            ...
            <a href="/layanan/setor" style="text-decoration: none">Kunjungi ></a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-4 col-sm-12">
          <div class="yukmulai" style="text-align: center;">
            ...
            <a class="btn text-white" style="margin-top: -50px;" href="/layanan/setor">Yuk mulai</a>
        </div>
        </div>
      </div>
    </div>
