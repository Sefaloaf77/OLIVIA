...
<!-- header -->
      ...
      <div class="container">
        <div class="row meet1 justify-content-center">
          ...
          <div class="col-lg-5 col-md-4 col-sm-12 text-center">
           ...
           <a href="/layanan/setor-barang" class="btn" style="text-decoration: none; color: #fff;">Setor</a>
          </div>
          <div class="col-lg-3 col-md-4 col-sm-12 ava2 text-lg-end text-center">
            <img src="/img/setor/ava4.png" class="img-fluid mt-5 mt-md-0" alt="avatar">
          </div>
        </div>
      </div>
     </section>
   ...
   <section class="cara">
       ...
       <h1 class="mt-5" style="color: #00b3bc;">Cara Setor</h1>
        ...
        <div class="row slider">
            ...
            <div class="col-md-12">
                <div class="row justify-content-center">
                    ...
                    <p style="font-size: 18px">
                        Kemasan plastik seperti kemasan makanan ringan yang akan disetor harus dibersihkan dahulu dengan cara dicuci agar tidak ada sisa makanan atau kotoran yang menempel. Setelah itu masukkan sampah yang telah kering ke dalam wadah yang bersih, seperti kardus atau kantong kemasan.
                    </p>
                    </div>
                </div>
            </div>
   ...
   <section class="text-center mt-5">
    <a href="/layanan/setor-barang" class="btn" style="text-decoration: none; color: #fff;">Setor Sekarang</a>
   </section>
