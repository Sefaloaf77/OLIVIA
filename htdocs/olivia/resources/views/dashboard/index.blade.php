...
@if (session()->has('kurang'))
      <!-- Modal -->
        <div class="modal hide fade" id="myModalHasil">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-body text-center">
                <img src="/img/silang.png" alt="silang" style="height: 150px; width: 150px;" class="img-fluid">
      ...
      <section id="dashboard">
        <div class="title d-flex justify-content-center">
          ...
          <h2 class="mt-3 text-center">Selamat datang di halaman dasbor!</h2>
        </div>
        <div class="container">
          <div class="row justify-content-evenly">
            <div class="col-11 col-sm-11 col-md-5 col-lg-5 kiri" data-aos="fade-right">
              <div class="d-flex avatar-edit justify-content-between"> 
                <img src="/img/avatar.png" class="img-fluid" alt="" style="border-radius: 50%;">
            ...
            <div class="col-11 col-sm-11 col-md-5 col-lg-5 kanan mt-3 mt-sm-3 mt-md-0 mt-lg-0" data-aos="fade-left">
              <div class="poin d-flex justify-content-between">
                <div class="text" style="color: #00b3bc;">
                  ...
                  <p>Ayo setorkan sampahmu dan kumpulkan poin nya, poin terpenuhi voucher menanti!</p>
                </div>
              ...
              <div class="vocer d-flex justify-content-between">
                <div class="text">
                  ...
                  <p>Gunakan voucher untuk mendapatkan potongan harga spesial pada toko kolega!</p>
                  <button class="btn text-light mt-4"><a href="/dashboard/riwayat-kupon" style="color: #fff; text-decoration: none;">Cek disini</a></button>
                </div>
                <img src="/img/vocer.svg" class="img-fluid" alt="voucher">
              </div>
            </div>
          </div>
        </div>
       ...
       <section id="cta">
        <div class="container">
          <div class="header text-center mx-auto">
              ...
              <a href="/layanan/kolega" style="color: #fff; text-decoration: none;" class="btn text-light mt-3">Kunjungi toko</a>
          </div>
        </div>
      </section>
      @endsection