...
@section('container')
    ...
    <div class="container text-center">
        ...
        <p>Kunjungi toko SAGA untuk mendapatkan produk daur ulang dengan kualitas dan harga terbaik</p>
    ...
    <div class="container">
        ...
        <div class="col-md-5 mt-md-5">
            ...
            <a href="/layanan/setor" style="text-decoration: none; color: #fff;" class="btn text-white mt-md-5">Setor Sekarang</a>
        </div>
        <div class="col-md-5">
