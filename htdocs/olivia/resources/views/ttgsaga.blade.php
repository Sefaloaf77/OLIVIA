...
@section('container')
    ...
    <div class="container">
        ...
        <div class="col-md-5 my-auto" data-aos="fade-left">
    ...
    <div class="container">
        ...
        <div class="row sobat mt-5 shadow justify-content-evenly align-items-center" data-aos="fade-up">
        <div class="col-md-4">
        ...
        <div class="row kurir mt-5 shadow justify-content-evenly align-items-center" data-aos="fade-up">
        <div class="col-md-4">
        ...
        <div class="col-md-5">
            ...
            <p style="color: #00b3bc;">Kurir atau Partner SAGA adalah bagian dari SAGA yang berperan sebagai penghubung antara Sobat SAGA dengan Kolega. Partner SAGA akan mengirimkan sampah yang disetorkan kepada pihak penerima.</p>
            <br>
        ...
        <div class="row kolega mt-5 shadow justify-content-evenly align-items-center" data-aos="fade-up">
        <div class="col-md-4">
    ...
    <div class="container">
        ...
        <div class="col-md-2 text-center" data-aos-delay="200" data-aos="zoom-in-up">
            <img src="/img/ttgsaga/action1.png" class="img-fluid mb-4" alt="action1">
            <p>Mengajak masyarakat untuk mulai mengurangi sampah</p>
        </div>
        <div class="col-md-2 text-center" data-aos-delay="400" data-aos="zoom-in-up">
        ...
        <div class="col-md-2 text-center" data-aos-delay="600" data-aos="zoom-in-up">
            <img src="/img/ttgsaga/action3.png" class="img-fluid mb-4" alt="action3">
            <p>Membuka Lapangan Pekerjaan baru</p>
        </div>
        <div class="col-md-2 text-center" data-aos-delay="800" data-aos="zoom-in-up">
    ...
    <div class="container">
        ...
        <div class="row justify-content-evenly">
        <div class="col-lg-3 col-md-5 col-sm-12 col-11 mt-sm-4 mt-4 card text-center ms-lg-2 ms-md-1 ms-sm-1 shadow" data-aos-delay="200" data-aos="zoom-out">
        ...
        <div class="col-lg-3 col-md-5 col-sm-12 col-11 mt-sm-4 mt-4 card text-center ms-lg-2 ms-md-1 ms-sm-1 shadow" data-aos-delay="400" data-aos="zoom-out">
        ...
        <div class="col-lg-3 col-md-5 col-sm-12 col-11 mt-sm-4 mt-4 card text-center ms-lg-2 ms-md-1 ms-sm-1 shadow" data-aos-delay="600" data-aos="zoom-out">
            <img src="/img/ttgsaga/ecology3.png" class="img-fluid" alt="target">
            <h6>“Menciptakan lingkungan yang bersih dan sehat”</h6>
        </div>
        <div class="col-lg-3 col-md-5 col-sm-12 col-11 mt-sm-4 mt-4 card text-center ms-lg-2 ms-md-1 ms-sm-1 shadow" data-aos-delay="800" data-aos="zoom-out">
        ...
        <div class="col-lg-3 col-md-5 col-sm-12 col-11 mt-sm-4 mt-4 card text-center ms-lg-2 ms-md-1 ms-sm-1 shadow" data-aos-delay="1000" data-aos="zoom-out">
            <img src="/img/ttgsaga/ecology5.png" class="img-fluid" alt="target">
            <h6>“Pelestarian bumi yang berkelanjutan”</h6>
        </div>
        <div class="col-lg-3 col-md-5 col-sm-12 col-11 mt-sm-4 mt-4 card text-center ms-lg-2 ms-md-1 ms-sm-1 shadow" data-aos-delay="1200" data-aos="zoom-out">
